"""CLI entry point for AI News XHS Publisher."""
...
from .orchestrator import AINewsXHSOrchestrator
...
def print_banner():
    ...
    banner = r"""
[bold blue]AI News XHS Publisher[/bold blue]
[cyan]AI news aggregation, rewriting, cover generation, and Xiaohongshu publishing[/cyan]
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(description="AI News XHS Publisher")
    ...
    try:
        ...
        orchestrator = AINewsXHSOrchestrator(config, storage)
