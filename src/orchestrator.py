...
class AINewsXHSOrchestrator:
    ...
    def __init__(self, config: Config, storage: StorageManager):
        ...
        self.xiaohongshu_publisher = (
            XiaohongshuPublisher(config.xiaohongshu, console=self.console)
            if config.xiaohongshu and config.xiaohongshu.enabled
            else None
        )
    ...
    async def run(self, force_hours: int = None) -> None:
        ...
        """
        self.console.print("[bold cyan]📰 AI News XHS Publisher - Starting aggregation...[/bold cyan]\n")
        ...
        try:
            ...
            for lang in self.config.ai.languages:
                ...
                if self.email_manager and self.config.email and self.config.email.enabled:
                    ...
                    subject = f"AI News XHS Summary ({lang.upper()}) - {today}"
                ...
                # Publish Xiaohongshu note if configured
                if self.xiaohongshu_publisher:
                    await self.xiaohongshu_publisher.publish_daily_summary(
                        summary=summary,
                        important_items=important_items,
                        date=today,
                        lang=lang,
            ...
            self.console.print("[bold green]✅ AI News XHS Publisher completed successfully![/bold green]")
    ...
    async def fetch_all_sources(self, since: datetime) -> List[ContentItem]:
        ...
        This is a stable stage entry point for integrations.
    ...
    def merge_cross_source_duplicates(self, items: List[ContentItem]) -> List[ContentItem]:
        ...
        This is a stable stage helper for integrations.
