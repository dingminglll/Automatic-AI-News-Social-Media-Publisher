                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr not in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Subscribed to AI News XHS",
                                            "You have been successfully subscribed to AI News XHS daily summaries.",
                                        )
                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Unsubscribed from AI News XHS",
                                            "You have been successfully unsubscribed from AI News XHS daily summaries.",
                                        )
